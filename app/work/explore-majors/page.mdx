...
**Timeframe:** [FILL IN — start month/year to end month/year]
...
Pathways to Careers is a college and career readiness platform serving roughly 10,000 students and family members across seven North Texas school districts, including Fort Worth ISD, Crowley ISD, Castleberry ISD, Grand Prairie ISD, Lake Worth ISD, Everman ISD, and Lamar High School in Arlington ISD.
...
**Texas has a career cluster taxonomy, and it doesn't cover higher education.** The state's CTE framework organizes 14 career clusters around workforce and technical pathways. It works well for high school CTE programs. It does not accommodate the academic majors a comprehensive university offers — there is no home in it for Philosophy, Anthropology, English Literature, or Comparative Race and Ethnic Studies.
...
Roughly [FILL IN — how many? "several dozen"?] majors had no reasonable home in the state's 14 clusters. Two options: force them into the nearest cluster, or extend the taxonomy.
...
I also added programs of study within the existing Arts, A/V Technology and Communications cluster — including **Graphic Design and Interactive Media** and **Fine & Performing Arts** — because the state's granularity was too coarse for the range of arts degrees our partners offered.
...
*Why:* This was a solo build across 539 records over [FILL IN duration]. Without review state in the model, I'd have had no reliable way to know what had been verified against the source catalog, and neither would anyone inheriting it.
...
[FILL IN — What shipped? Did the feature launch? Is it live? If you don't know because you moved departments, say exactly that: "I transitioned to a different department before implementation completed, so I don't have visibility into the final shipped experience." That's an honest and completely acceptable answer.]
